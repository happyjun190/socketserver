package com.socketserver.thrack.cache;
...
public interface IRedisOperator {
	 ...
	 *            单位秒
	 */
	void set(final String key, final String value, final Integer liveTime);
	 ...
	 * @param field
	 */
	void hincrBy(String key, String field);
	 ...
	 *            生存时间，秒
	 */
	void hset(final String key, final String field, final String value, int seconds);
	 ...
	 * @param fields
	 */
	void lpush(String key, String... fields);
