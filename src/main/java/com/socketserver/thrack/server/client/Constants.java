...
public class Constants
{
	...
	public enum StartAddrAndReadSize{
		ADDR_1600("1600", 14,  1),		//读取0x1600~0x160D段位14个寄存器数据
		ADDR_1616("1616", 10,  2),		//读取0x1616~0x161F段位10个寄存器数据
		ADDR_1652("1652", 10,  3),		//读取0x1652~0x165B段位10个寄存器数据
		ADDR_1670("1670", 14,  4),		//读取0x1670~0x167D段位14个寄存器数据
		ADDR_168E("168E", 2 ,  5),		//读取0x168E~0x168F段位 2个寄存器数据
		ADDR_1690("1690", 32,  6),		//读取0x1690~0x16AF段位32个寄存器数据
		ADDR_1800("1800", 80,  7),		//读取0x1800~0x184F段位32个寄存器数据
		;
