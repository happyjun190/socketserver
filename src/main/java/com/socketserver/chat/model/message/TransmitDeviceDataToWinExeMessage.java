package com.socketserver.chat.model.message;
 ...
 * 2016/10/25
 */
public class TransmitDeviceDataToWinExeMessage {
	 ...
	 * @param message
	 */
	public TransmitDeviceDataToWinExeMessage(byte[] message) {
	 ...
	 * @return
	 */
	public byte[] getBytesFromTransmitDeviceDataToWinexeMessage() {
		//数据长度为基本长度(29)+数据区长度
